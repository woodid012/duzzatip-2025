...
export const INJURIES = {
  ...
  // Essendon
  "Nic Martin":           { status: "SEASON", detail: "Knee ACL — out all 2026" },
  ...
  "Harry Sharp":          { status: "DOUBT",  detail: "Hamstring" },
  ...
  "Callum Coleman-Jones": { status: "WEEKS",  detail: "Calf" },
  "Aidan Corr":           { status: "WEEKS",  detail: "Calf" },
  ...
  "Mitch Georgiades":     { status: "DOUBT",  detail: "Hamstring, assessed post-Origin" },
  ...
  "Tom Sims":             { status: "WEEKS",  detail: "Navicular foot surgery" },
  ...
  // St Kilda
  "Max King":             { status: "MONTHS", detail: "Back stress fracture, out 6 months" },
